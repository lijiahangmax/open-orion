...
<span class="line"><span>service nginx start</span></span></code></pre></div><h3 id="测试访问" tabindex="-1">测试访问 <a class="header-anchor" href="#测试访问" aria-label="Permalink to &quot;测试访问&quot;">​</a></h3><p>在浏览器中输入 <a href="http://localhost" target="_blank" rel="noreferrer">http://localhost</a> 访问<br> 账号: <code>admin</code><br> 密码: <code>admin</code></p>`,17),l=[e];function t(o,r,c,h,d,g){return n(),a("div",null,l)}const m=s(i,[["render",t]]);export{_ as __pageData,m as default};
