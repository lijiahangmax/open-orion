import{_ as s,c as a,o as n,a3 as p}from"./chunks/framework.M2ANHPtw.js";const m=JSON.parse('{"title":"普通安装","description":"","frontmatter":{"title":"普通安装"},"headers":[],"relativePath":"quickstart/install.md","filePath":"quickstart/install.md"}'),i={name:"quickstart/install.md"},e=p(`<h3 id="所需环境" tabindex="-1">所需环境 <a class="header-anchor" href="#所需环境" aria-label="Permalink to &quot;所需环境&quot;">​</a></h3><ul><li>jdk 1.8</li><li>mysql 8.0.+</li><li>redis 6.0.+</li><li>maven 3.5.+</li><li>node 18.12.+</li><li>pnpm 9.1.+</li><li>nginx</li></ul><div class="tip custom-block"><p class="custom-block-title">提示</p><p>⚡ maven 推荐使用阿里云 mirror<br> ⚡ npm 建议使用淘宝镜像 <code>npm config set registry https://registry.npmmirror.com/</code><br> ⚡ pnpm 建议使用淘宝镜像 <code>pnpm config set registry https://registry.npmmirror.com/</code></p></div><h3 id="拉取代码" tabindex="-1">拉取代码 <a class="header-anchor" href="#拉取代码" aria-label="Permalink to &quot;拉取代码&quot;">​</a></h3><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># github</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">git</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> clone</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> https://github.com/dromara/orion-visor</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># gitee</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">git</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> clone</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> https://gitee.com/dromara/orion-visor</span></span></code></pre></div><h3 id="初始化数据库" tabindex="-1">初始化数据库 <a class="header-anchor" href="#初始化数据库" aria-label="Permalink to &quot;初始化数据库&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 执行脚本</span></span>
